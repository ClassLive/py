...
import ujson
# Penguincord source code (slightly modified example server)
# TODO:
# - Fix errors in console
# - Figure out how to respond to cammands ye
from pysondb import db
database=db.getDb("database.json")
file1 = open("featured.json", "r")
...
class example_commands:
    ...
    async def get_chat(self, client, val, listener):
        print("Getchat!")
        chat = database.get(val)
        payload = {
    			"cmd": "direct",
    			"val": {
    				"mode": "post",
